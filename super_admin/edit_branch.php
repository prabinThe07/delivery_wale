    ...
    if (empty($errors)) {
        try {
            ...
            $stmt->execute([
                ...
                $phone, $email, $manager_name, $status, $branch_id
            ]);
...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-md-6">
            <h2><i class="fas fa-edit me-2"></i>Edit Branch</h2>
            <p class="text-muted">Update branch information</p>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
            <form action="edit_branch.php?id=<?php echo $branch_id; ?>" method="post" class="needs-validation" novalidate>
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                ...
                <div class="d-flex justify-content-end">
                    <a href="branches.php" class="btn btn-secondary me-2">Cancel</a>
